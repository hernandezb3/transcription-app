...
export default function InlineCommentInput({
  ...
  // Inline, in-app error. Native alert() can be silently suppressed in Firefox
  // ("prevent this page from creating additional dialogs"), which would swallow
  // the failure entirely — so surface it in the DOM instead.
  ...
  return (
    <div className="flex flex-col gap-1">
      ...
      {errorMsg && (
        <p role="alert" className="px-1 text-xs font-medium text-red-600 dark:text-red-400">
          {errorMsg}
        </p>
      )}
    </div>
